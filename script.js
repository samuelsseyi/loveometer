const loveButton = () => {
  ...
  if (maleInput === "" || femaleInput === "") {
    ...
    errorDiv.innerHTML =
      "Uh-oh! It Takes Two to Tangle. Please Enter Both Names.";
    ...
    if (loveLevel <= 20) {
      document.getElementById(
        "lovePercent"
      ).innerHTML = `${loveLevel}%: 🙈 Oops! Looks like you're in the friend zone!`;
    } else if (loveLevel <= 40) {
      document.getElementById(
        "lovePercent"
      ).innerHTML = `${loveLevel}%: 💔 Ummm! Looks like your love needs a jump start!`;
    } else if (loveLevel <= 60) {
      document.getElementById(
        "lovePercent"
      ).innerHTML = `${loveLevel}%: 💑Your love's got potential, but it needs a serious upgrade! `;
